...
class TestRegistryCoverage:
    ...
    def test_field_count_is_24(self):
        assert len(CHAT_SETTINGS_FIELDS) == 24
...
class TestLegacySplit:
    ...
    def test_new_fields_count_is_11(self):
        assert len(new_fields()) == 11
