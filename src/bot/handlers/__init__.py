...
# callbacks, C-1 -- own prefix, replaces the placeholder that used to live in
# admin_router), then rules (ar_ callbacks + FSM state), then commands, then
# callbacks, media (voice/photo/sticker), then the generic text handler last.
#
